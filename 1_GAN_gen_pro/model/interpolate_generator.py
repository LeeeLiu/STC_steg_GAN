...
class Unet(nn.Module):
    def __init__(self):
        ...
        self.layer2 = UnetDownConv(16, 32)     # 32*256
        self.layer3 = UnetDownConv(32, 64)     # 16*128
        self.layer4 = UnetDownConv(64, 128)    # 8*64
        self.layer5 = UnetDownConv(128, 128)   # 4*32
        self.layer6 = UnetDownConv(128, 128)   # 2*16
        self.layer7 = UnetUpConv(128, 128)      # 4*32
        self.layer8 = UnetUpConv(256, 128)     # 8*64
        self.layer9 = UnetUpConv(256, 64)     # 16*128
        self.layer10 = UnetUpConv(128, 32)     # 32*256
        self.layer11 = UnetUpConv(64, 16)      # 64*512
        self.layer12 = UnetUpConv(32, 1)      # 128*1024
    ...
    def forward(self, x):
        ...
        # print(x12.shape)
        x13 = self.act_fun1(x12) - 0.5     # -0.5 -- 0.5
        # print(x13.shape)
...
# debug mode
    ...
    print(x)
    x = F.interpolate(x, size=[2*2, 2*2], scale_factor=None, mode='nearest', align_corners=None)
    print(x)
